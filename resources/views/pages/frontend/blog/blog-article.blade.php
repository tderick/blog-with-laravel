        ...
        <div class="container">
            ...
            @foreach ($blogs as $blog)
                <div class="col-lg-6 col-md-6 mb-5">
                        ...
                        <div class="blog-item">
                            <div class="blog-item">
                                <img src="{{ asset('images/blog/1.jpg') }}" alt="" class="img-fluid rounded">
                                ...
                                <div class="blog-item-content bg-white p-5">
                                    ...
                                    <h3 class="mt-3 mb-3"><a href="blog-single.html">{{ $blog->name }}</a></h3>
                                    <p class="mb-4">{{ $blog->desc }}</p>
                                    <a href="{{route('detail',$blog->slug)}}" class="btn btn-small btn-main btn-round-full">Learn More</a>
                                </div>
                            </div>
                        </div>
                    </div>
